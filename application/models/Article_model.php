...
class Article_model extends CI_Model {
    ...
    public function getAuthorByArticleId($articleId) {
        ...
        $result = $query->row();
        error_log('Query Result for Article ID ' . $articleId . ': ' . print_r($result, true));
    ...
    public function get_articles() {
        $this->db->select('articles.*, authors.author_name'); // Adjust fields as needed
        $this->db->from('articles');
        // $this->db->join('authors', 'authors.audid = articles.author_id', 'left');
        $query = $this->db->get(); 
...
public function get_article() {
    $this->db->select('articles.articleid, articles.title, articles.slug, articles.abstract, articles.created_at, volume.vol_name, articles.doi, articles.keywords, articles.authors');
    $this->db->from('articles');
