    ...
    <div class="container px-4 px-lg-5">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4" href="<?php echo base_url(); ?>">Volumes</a></li>
        ...
        <div class="row gx-4 gx-lg-5 justify-content-center">
            <div class="col-md-10 col-lg-8 col-xl-7">
                ...
                <p><strong>Abstract:</strong> <?php echo $article->abstract; ?></p>
                        <span class="meta">
                            Author: <small><a href="#!"><?php echo $article->authors; ?></a> Published on: <?php echo date('F d, Y', strtotime($article->created_at)); ?></small>
                        </span>
                    </div>
            </div>
        </div>
