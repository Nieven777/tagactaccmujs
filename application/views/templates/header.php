...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo base_url('assets/img/cellsmall.png')?>">
    <!-- Custom CSS -->
...
<body>
    ...
    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
        <li><a class="dropdown-item" href="<?php echo base_url('pages/db_adminProfile'); ?>">Profile</a></li>
